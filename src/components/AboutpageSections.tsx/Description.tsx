    ...
    <div className='w-[100%] flex justify-center bg-[#f8f9fd] pb-[35px] pt-[35px]'>
        ...
        <div className='flex grid-cols-[1fr,0.8fr] gap-12 max-lg:grid-cols-1 flex-wrap'>
            ...
            <div className='w-[60%] md:w-[100%] sm:w-[100%]'>
                <p className='text-justify text-[18px] sm:text-[15px] max-md:text-[14px] leading-relaxed text-white'>
                ...
                <p className='mt-8 text-[18px] text-justify sm:text-[15px] max-md:text-[14px] leading-relaxed text-white'>
            ...
            <div className=' justify-center items-center max-md:h-[350px] h-[370px] md:h-[420px] w-[390px] md:w-[100%]' >
                <Image src={img} alt='/' className='rounded-se-3xl rounded-bl-3xl object-cover w-full h-full'/>
            </div>
        </div>
