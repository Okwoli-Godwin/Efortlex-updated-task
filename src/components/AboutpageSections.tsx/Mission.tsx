...
const Mission = () => {
    ...
    <div className='w-[100%] flex justify-center bg-[#f8f9fd]'>
        <section className='p-[25px] pt-[40px] h-full max-lg:p-12 max-md:p-8 max-lg:mx-5 rounded-xl bg-white w-[95%] flex flex-wrap md:flex-col-reverse sm:flex-col-reverse items-center pb-[35px] justify-between mb-[35px]'>
            <div className='w-[490px] md:w-[100%] sm:w-[100%] h-[460px] md:h-[450px] md:mt-[25px] sm:mt-[25px]'>
            ...
            <div className='w-[55%] md:w-[100%] sm:w-[100%] flex flex-col'>
                ...
                <p className='mt-[20px] md:text-justify text-[18px] sm:text-justify'>
                    Our mission is to innovate sustainable solutions and nurture the competencies of our client organizations
                    in the private and public sectors to improve their business operations and achieve business success.
                </p>
            </div>
        </section>
    </div>
