...
const ResearchAreas = () => {
  return (
    <div className='w-[100%] flex justify-center mt-[80px]'>
        <div className='w-[90%] flex flex-col items-center'>
            <h3 className='text-[28px] font-[700] text-[#3E5BC3]'>Our Research Areas</h3>
            
            <div className='w-[100%] sm:w-[90%] md:w-[90%] flex mt-[40px] sm:mt-[15px] justify-between flex-wrap'>
