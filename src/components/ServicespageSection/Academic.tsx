...
const Academic = () => {
  return (
    <div className='w-[100%] flex justify-center mt-[60px] sm:mt-[20px]'>
        <div className='w-[90%] flex flex-col'>
            <h3 className='text-[28px] sm:text-[24px] font-[700] text-[#4C80BC]'>A-Class Academic Consults</h3>
            <h2 className='text-[30px] sm:text-[25px] font-[700]'>Limited AI research consists of the following;</h2>

            <div className='w-[100%] flex flex-col mt-[30px]'>
                <div className='flex-col ml-[20px]'>
                    <ul className='list-disc'>
                    <li>
                        <span className='text-[17px] font-[700]'>Sentiment analysis:</span>
                    ...
                    <ul className='list-disc'>
                    <li>
                        <span className='text-[17px] font-[700]'>Predictive analytics:</span>
                        <p className='text-[#434141] mb-[20px] text-[18px] sm:text-[15px] md:text-justify sm:text-justify'>
                    ...
                    <ul className='list-disc'>
                    <li>
                        <span className='text-[17px] font-[700]'>Consumer segmentation:</span>
                        <p className='text-[#434141] mb-[20px] text-[18px] sm:text-[15px] md:text-justify sm:text-justify'>
                    ...
                    <ul className='list-disc'>
                    <li>
                        <span className='text-[17px] font-[700]'>Customer journey analysis:</span>
                        <p className='text-[#434141] mb-[20px] text-[18px] sm:text-[15px] md:text-justify sm:text-justify'>
                    ...
                    <ul className='list-disc'>
                    <li>
                        <span className='text-[17px] font-[700]'>Demand forecasting:</span>
                        <p className='text-[#434141] mb-[20px] text-[18px] sm:text-[15px] md:text-justify sm:text-justify'>
