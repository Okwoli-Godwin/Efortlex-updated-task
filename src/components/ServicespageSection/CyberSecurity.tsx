  ...
  return (
    <div className='w-[100%] flex justify-center mt-[40px]'>
        <div className='w-[90%] flex flex-col'>
            <h3 className='text-[24px] font-[700] text-[#566599]'>CYBERSECURITY</h3>
            <p className='text-[18px] text-[#434141] mt-[10px]'>
            ...
            <div className='w-[100%] flex justify-between flex-wrap mt-[40px]'>
                <div className='w-[48%] flex flex-col md:w-[100%] sm:w-[100%]'>
                    <div className='w-[100%] py-[30px] px-[12px] border-[2px] border-[#CD9090] flex flex-col items-center mb-[30px]'>
                        <h4 className='text-[#4C80BC] text-[20px] font-[700] text-center'>Assess risks and IT resilience</h4>
                    ...
                    <div className='w-[100%] py-[30px] px-[12px] border-[2px] border-[#7F5608] flex flex-col items-center mb-[20px]'>
                        <h4 className='text-[#4C80BC] text-[20px] font-[700] text-center'>Enable Digital Transformation</h4>
                        <p className='text-[17px] text-[#434141] mt-[10px] text-center'>
                ...
                <div className='w-[48%] flex flex-col md:w-[100%] sm:w-[100%]'>
                    <div className='w-[100%] py-[30px] px-[12px] border-[2px] border-[#4C80BC] flex flex-col items-center mb-[30px]'>
                        <h4 className='text-[#4C80BC] text-[20px] font-[700] text-center'>Building long-term cyber capabilities</h4>
                        <p className='text-[17px] text-[#434141] mt-[10px] text-center'>
                    ...
                    <div className='w-[100%] py-[30px] px-[12px] border-[2px] border-[#196A0C] flex flex-col items-center mb-[30px]'>
                        <h4 className='text-[#4C80BC] text-[20px] font-[700] text-center'>Establishing Crisis response and preparedness</h4>
                        <p className='text-[17px] text-[#434141] mt-[10px] text-center'>
