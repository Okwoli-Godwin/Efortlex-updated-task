  ...
  return (
    <div className='w-[100%] flex justify-center mt-[60px]'>
        <div className='w-[90%] flex flex-col items-center'>
            <h1 className='text-[27px] sm:text-[23px] font-[700] text-[#4C80BC]'>EMBEDED SYSTEMS</h1>
            <p className='text-center sm:mt-[15px] text-[#434141] text-[18px] sm:text-[15px]'>
            ...
            <div className='w-[100%] flex flex-wrap justify-between mt-[30px]'>
                ...
                <div className='w-[48%] sm:w-[100%] md:w-[100%] py-[45px] mb-[30px] px-[20px] bg-[#F8FFF7] flex flex-col items-center'>
                            <h3 className='text-[20px] text-center font-[700] text-[#4C80BC] mt-[25px]'>Increased efficiency and productivity: </h3>
                            <p className='text-center text-[16px] mt-[25px]'>
                ...
                <div className='w-[48%] sm:w-[100%] md:w-[100%] py-[45px] mb-[30px] px-[20px] bg-[#F3F4FC] flex flex-col items-center'>
                            <h3 className='text-[20px] font-[700] text-[#4C80BC] mt-[25px]'>Cost Savings </h3>
                            <p className='text-center text-[16px] mt-[25px]'>
                ...
                <div className='w-[48%] sm:w-[100%] md:w-[100%] py-[45px] mb-[30px] px-[20px] bg-[#FFF6F6] flex flex-col items-center'>
                            <h3 className='text-[20px] font-[700] text-[#0A6618] mt-[25px]'>Scalability and Flexibility: </h3>
                            <p className='text-center text-[16px] mt-[25px]'>
